...
!function(a, b) {
    ...
    var a = "d3pie"
      ...
      , f = {
        ...
        processObj: function(a, b, c) {
            return "string" == typeof b ? f.processObj(a, b.split("."), c) : 1 === b.length && void 0 !== c ? (a[b[0]] = c,
            a[b[0]]) : 0 === b.length ? a : f.processObj(a[b[0]], b.slice(1), c)
        },
      ...
      , g = function() {
        var a, b, c, d, e, f, h = arguments[0] || {}, i = 1, j = arguments.length, k = !1, l = Object.prototype.toString, m = Object.prototype.hasOwnProperty, n = {
        ...
        i; j > i; i++)
            if (null !== (a = arguments[i]))
                for (b in a)
                    c = h[b],
                    d = a[b],
                    h !== d && (k && d && (o.isPlainObject(d) || (e = o.isArray(d))) ? (e ? (e = !1,
                    f = c && o.isArray(c) ? c : []) : f = c && o.isPlainObject(c) ? c : {},
                    h[b] = g(k, f, d)) : void 0 !== d && (h[b] = d));
        return h
    }
      , h = {
      ...
      , i = {
        add: function(a, b, c) {
            ...
            d.mainLabel && g.append("text").attr("id", function(c, d) {
                ...
                var b = a.label;
                return e.truncation.enabled && a.label.length > e.truncation.length && (b = a.label.substring(0, e.truncation.length) + "..."),
                b
            ...
            d.percentage && g.append("text").attr("id", function(c, d) {
                ...
                return j.getPercentage(a, c, a.options.labels.percentage.decimalPlaces) + "%"
        ...
        computeLinePosition: function(a, b) {
            var c, d, e, f, g = j.getSegmentAngle(b, a.options.data.content, a.totalSize, {
                midpoint: !0
            }), i = h.rotate(a.pieCenter.x, a.pieCenter.y - a.outerRadius, a.pieCenter.x, a.pieCenter.y, g), k = a.outerLabelGroupData[b].h / 5, l = 6, m = Math.floor(g / 90), n = 4;
            switch (2 === m && 180 === g && (m = 1),
            m) {
            case 0:
                c = a.outerLabelGroupData[b].x - l - (a.outerLabelGroupData[b].x - l - i.x) / 2,
                d = a.outerLabelGroupData[b].y + (i.y - a.outerLabelGroupData[b].y) / n,
        ...
        fadeInLabelsAndLines: function(a) {
            ...
            setTimeout(function() {
                ...
                f.isFunction(a.options.callbacks.onload) && setTimeout(function() {
                    try {
        ...
        adjustLabelPos: function(a, b, c, d) {
            ...
            f = d.center.y - h,
            e = Math.sqrt(Math.abs(d.lineLength) > Math.abs(f) ? d.lineLength * d.lineLength - f * f : f * f - d.lineLength * d.lineLength),
      ...
      , j = {
        create: function(a) {
            var b = a.pieCenter
              ...
              , k = d.speed;
            "none" === d.effect && (k = 0),
            i.append("path").attr("id", function(b, c) {
            ...
            a.svg.selectAll("g." + a.cssPrefix + "arc").attr("transform", function(b, c) {
                var d = 0;
                return c > 0 && (d = j.getSegmentAngle(c - 1, a.options.data.content, a.totalSize)),
                "rotate(" + d + ")"
            }),
            a.arc = g
        },
        ...
        addSegmentEventHandlers: function(a) {
            ...
            b.on("click", function() {
                ...
                "none" !== a.options.effects.pullOutSegmentOnClick.effect && (e ? j.closeSegment(a, b.node()) : j.openSegment(a, b.node()))
            }),
        ...
        openSegment: function(a, b) {
            ...
            d3.selectAll("." + a.cssPrefix + "expanded").length > 0 && j.closeSegment(a, d3.select("." + a.cssPrefix + "expanded").node()),
            d3.select(b).transition().ease(a.options.effects.pullOutSegmentOnClick.effect).duration(a.options.effects.pullOutSegmentOnClick.speed).attr("transform", function(b) {
                ...
                d3.select(this).attr("class", a.cssPrefix + "expanded")
            }))
        },
      ...
      , l = {
        addTooltips: function(a) {
            ...
            b.selectAll("." + a.cssPrefix + "tooltip").data(a.options.data.content).append("text").attr("fill", function() {
        ...
        moveTooltip: function(a) {
            d3.selectAll("#" + a.cssPrefix + "tooltip" + l.currentTooltip).attr("transform", function() {
                var b = d3.mouse(this.parentNode)
                  , c = b[0] + a.options.tooltips.styles.padding + 2
                  , d = b[1] - 2 * a.options.tooltips.styles.padding - 2;
        ...
        hideTooltip: function(a, b) {
            ...
            d3.select("#" + a.cssPrefix + "tooltip" + l.currentTooltip).attr("transform", function() {
                var b = a.options.size.canvasWidth + 1e3
                  , c = a.options.size.canvasHeight + 1e3;
        ...
        replacePlaceholders: function(a, b, c, d) {
            ...
            var e = function() {
                return function() {
                    var a = arguments[1];
                    return d.hasOwnProperty(a) ? d[arguments[1]] : arguments[0]
                }
            };
      ...
      , m = function(i, j) {
        ...
        c++),
        e.initialCheck(this) && (d3.select(this.element).attr(a, b),
        this.options.data.content = h.sortPieData(this),
        this.options.data.smallSegmentGrouping.enabled && (this.options.data.content = f.applySmallSegmentGrouping(this.options.data.content, this.options.data.smallSegmentGrouping)),
    ...
    var n = function() {
        ...
        f.whenElementsExist(b, function() {
            ...
            a.options.labels.lines.enabled && "none" !== a.options.labels.outer.format && i.addLabelLines(a),
